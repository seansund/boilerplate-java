...
public class StringUtilTest2 {
	...
	@Test public void isNull_Empty() {
		assertFalse StringUtil.isNull("")
	}
	@Test public void isNullOrEmpty_Null() {
		assertTrue StringUtil.isNullOrEmpty(null)
	}
	@Test public void isNullOrEmpty_Empty() {
		assertTrue StringUtil.isNullOrEmpty("")
	}
	@Test public void isNullOrEmpty_NonEmpty() {
		assertFalse StringUtil.isNullOrEmpty("Test")
	}
	@Test public void isNullOrEmpty_Spaces() {
		assertFalse StringUtil.isNullOrEmpty("  ")
	}
	@Test public void isNullOrEmptyTrim_Null() {
		assertTrue StringUtil.isNullOrEmptyTrim(null)
	}
	@Test public void isNullOrEmptyTrim_Spaces() {
		assertTrue StringUtil.isNullOrEmptyTrim("  ")
	}
	@Test public void isNullOrEmptyTrim_NonSpaces() {
		assertFalse StringUtil.isNullOrEmptyTrim("Test")
	}
	@Test public void substring_Good() {
		assertThat StringUtil.substring("Testvalue", 0, 4), is("Test")
	}
	@Test public void substring_Null() {
